...
enum LayoutTokens {
    ...
    // Tabs
    static let tabWidthMin: CGFloat = 84
    static let tabWidthMax: CGFloat = 112
    static let tabHeightMin: CGFloat = 32
    static let tabHeightMax: CGFloat = 40
...
enum DrawerPanel {
    ...
    static func drawerWidth(for screenWidth: CGFloat) -> CGFloat {
        Layout.clamp(screenWidth * 0.42, 260, 340)
    }
    
    static func rightPanelWidth(for screenWidth: CGFloat) -> CGFloat {
        Layout.clamp(screenWidth * 0.55, 360, 520)
    }
}
